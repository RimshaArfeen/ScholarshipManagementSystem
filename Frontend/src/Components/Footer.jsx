...
<footer className="bg-gray-900 dar heading-custom">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-custom dark:text-gray-400 font-medium">
                      ...
                      <NavLink to="/applicationInfo" className=" mt-[72px] w-full inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center heading-custom rounded-lg bg-custom  focus:ring-4 focus:ring-gray-500 dark:focus:ring-gray-900">
              Apply now
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-custom sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
          </span>
