               ...
               <div  className="w-full py-16 pt-0 -mt-36">
                    ...
                    <div  className="container px-5 py-24 mx-auto">
                         <div  className=" mb-20">
                              ...
                              <p  className="text-base text-gray-700 leading-relaxed lg:w-3/4 tracking-wide text-justify  ">
...
bg-gray-400 bg-blend-multiply overflow-hidden my-20">
                         <div  className="px-4 pl-14 w-full md:w-3/4 py-24 lg:py-48 lg:pt-56 ">
                              ...
                              <p  className="mb-8 text-lg font-normal text-gray-800 lg:text-xl">
                              ...
                              return (
                                   ...
                                   <div key={index} className="max-w-3xl ">
                                        <details className="mb-4">
                                             ...
                                             <p className="mt-2 text-gray-600 pl-4 w-fit">{item.answer}
